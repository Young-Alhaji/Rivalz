  ...
  return (
    <> <center>
      <div className="navHead">
        <div >
          <img src="logo.jpg" alt="Base Logo" className="logoImg"/>
        </div>
        <div className="baseTitle">RIVALZ</div>
        <button className="newsletterBtn" onClick={subscribe}>Subscribe</button>
      </div> 
      <div className="navHeadMargin">
        <p className="pAnimation">RIVALZ AI is built for everyone</p>
        <div className="reply">
        {reply}
      </div>
      </div>
      ...
      <div>
        <h2 className="askaianything">Ask AI anything about RIVALZ</h2>
      </div> <br />
